...
public class Timer1 : MonoBehaviour {
   ...
   private void ResetTimer () {
      ...
      Duration = remainingDuration = 120 ;
   ...
   //-- Events ----------------------------------
   public Timer1 OnBegin (UnityAction action) {
      onTimerBeginAction = action ;
      return this ;
   }

   public Timer1 OnChange (UnityAction<int> action) {
      onTimerChangeAction = action ;
      return this ;
   }

   public Timer1 OnEnd (UnityAction action) {
      onTimerEndAction = action ;
      return this ;
   }

   public Timer1 OnPause (UnityAction<bool> action) {
