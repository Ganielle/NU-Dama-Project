...
public class BoardDama : MonoBehaviour
{
    [Header("Art stuff")]
    ...
    private void SpawnAllPieces(){
        ...
        //White Team
        unitPieces[1, 2] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[3, 2] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[5, 2] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[7, 2] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[0, 1] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[2, 1] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[4, 1] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);      
        unitPieces[6, 1] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[1, 0] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[3, 0] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[5, 0] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        unitPieces[7, 0] = SpawnSinglePiece(UnitPieceType.Pawn, whiteTeam);
        

         //Black Team
        unitPieces[1, 5] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[3, 5] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[5, 5] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[7, 5] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[0, 6] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[2, 6] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[4, 6] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[6, 6] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[1, 7] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[3, 7] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[5, 7] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);
        unitPieces[7, 7] = SpawnSinglePiece(UnitPieceType.BPawn, blackTeam);        
    }
